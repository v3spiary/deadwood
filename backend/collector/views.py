...
class AreaViewSet(viewsets.ModelViewSet):
    ...
    def nodes(self, request, pk=None):
        ...
        serializer = InformationNodeListSerializer(nodes, many=True, context={'request': request})
        return Response(serializer.data)
...
class NodeLinkViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return NodeLink.objects.filter(
            from_node__user=self.request.user,
            to_node__user=self.request.user
        )
...
class ProcessingSessionViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def daily_summary(self, request):
        ...
        summary = ProcessingSession.objects.filter(
            user=request.user,
